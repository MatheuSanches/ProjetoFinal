...
namespace ProjetoFinal.DbLojaDataSetTableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cliente] ([cpf], [nome], [endereco], [celular], [email]) VALUE" +
                "S (@cpf, @nome, @endereco, @celular, @email);\nSELECT cpf, nome, endereco, celula" +
                "r, email FROM cliente WHERE (cpf = @cpf)";
...
SELECT cpf, nome, endereco, celular, email FROM cliente WHERE (cpf = @cpf)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjetoFinal.Properties.Settings.Default.bancoComercioConnectionString;
        }
