    ...
    public partial class FrmCrudUsuario : Form
    {
        ...
        private void btnCadastro_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                CarregaDgvUsuario();
                MessageBox.Show("Usuario cadastrado com sucesso!", "Incluir Cadastro", MessageBoxButtons.OK);
                Conexao.fecharConexao();
                txtId.Text = "";
                txtNome.Text = "";
                txtLogin.Text = "";
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@login", this.txtLogin.Text.Trim());
                cmd.Parameters.AddWithValue("@senha", this.txtSenha.Text.Trim());
                Conexao.obterConexao();
                cmd.ExecuteNonQuery();
                CarregaDgvUsuario();
                MessageBox.Show("Usuario atualizado com sucesso!", "Atualizar Cadastro", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Conexao.fecharConexao();
                txtId.Text = "";
                txtNome.Text = "";
                txtLogin.Text = "";
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                CarregaDgvUsuario();
                MessageBox.Show("Usuario excluido com sucesso!", "Excluir Cadastro", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                Conexao.fecharConexao();
                txtId.Text = "";
                txtNome.Text = "";
                txtLogin.Text = "";
