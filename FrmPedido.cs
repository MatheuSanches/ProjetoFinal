    ...
    public partial class FrmPedido : Form
    {
        ...
        private void btnNovoItem_Click(object sender, EventArgs e)
        {
            if(botaoclicado==1)
            {
                ...
                pedido2.Parameters.AddWithValue("@usuario", SqlDbType.VarChar).Value = txtUsuario.Text.Trim();
            ...
            else//Após clicar em Abrir pedido e adicionar novo item, será encaminhado até aqui
            {
                DataGridViewRow item = new DataGridViewRow();
                item.CreateCells(dgvPedido);
                item.Cells[0].Value = txtId.Text;
                item.Cells[1].Value = txtUsuario.Text.Trim();
